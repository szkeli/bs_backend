...
import { AvatarImageUploadCredentialInfo, PostImagesUploadCredentialInfo, STSDto, SubjectImagesUploadCredentialInfo } from './models/sts.model'
...
export class StsService {
  ...
  async getSubjectImagesUploadCredentialInfo (id: string, fileNames: string[]): Promise<SubjectImagesUploadCredentialInfo> {
